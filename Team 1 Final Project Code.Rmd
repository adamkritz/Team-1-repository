...
```{r, results='markup'}
diamondscont1 <- subset(diamonds, select = c ("carat", "depth", "table", "price", "x", "y", "z"))
```
...
# Linear regression model with 1 components 
```{r}
linear_model_pcr_1 = lm(price~ carat + z   , data= diamondscont)
summary(linear_model_pcr_1)
```
